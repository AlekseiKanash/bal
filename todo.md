...
5. To implement CPU load getter function and CPU meter
6. To implement GPU load getter function and GPU meter
7. To implement Memory Cnsumption getter function and RAM meter

Then try to change update mechanism for Tick(time) function to delta time since last call.